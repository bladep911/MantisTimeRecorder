...
$reports_arr = array(
    ...
    'issues_by_reopenings'          => lang_get( 'plugin_MantisStats_by_reopenings'),
    'issues_by_attachments'         => lang_get( 'plugin_MantisStats_by_attachments'),
    ...
    'time_to_resolution'            => lang_get( 'plugin_MantisStats_by_time_to_resolution'),
    'time_in_state'                 => lang_get( 'plugin_MantisStats_by_time_in_state'),
    'time_to_first_note'            => lang_get( 'plugin_MantisStats_by_time_to_first_note'),
    ...
    'trends_by_attachments'         => lang_get( 'plugin_MantisStats_trends_attachments' )
);
